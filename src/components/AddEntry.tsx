          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                autoFocus
              />
              <span className="absolute right-4 bottom-4 text-[10px] text-wabi-stone font-sans">TWD</span>
            </div>
          </div>
        )}
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <label className="text-[10px] text-wabi-stone uppercase tracking-widest px-1">目前市價 Price</label>
                  {formData.symbol && (
                    <button 
                      type="button"
                      onClick={async () => {
